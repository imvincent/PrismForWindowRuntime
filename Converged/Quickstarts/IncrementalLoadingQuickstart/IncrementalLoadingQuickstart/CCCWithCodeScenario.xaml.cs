...
namespace IncrementalLoadingQuickstart
{
    ...
    /// </summary>
    public sealed partial class CCCWithCodeScenario : Page
    {
        ...
        /// <summary>
        /// We will visualize the data item asynchronously in multiple phases for improved panning user experience 
